...
void TMVARegression() 
{
   ...
   factory->AddVariable("W_pt", 'F');
   factory->AddVariable("W_y", 'F');
   factory->AddVariable("W_mt", 'F');
   ...
   factory->AddVariable("metSig := event_met_pfmetsignificance", 'F');
   factory->AddVariable("set := event_met_pfsumet", 'F');
   ...
   factory->AddSpectator("nuPx_gen := W_neutrino_px_gen", "F");
   factory->AddSpectator("nuPy_gen := W_neutrino_py_gen", "F");
   factory->AddSpectator("nuPz_gen := W_neutrino_pz_gen", "F");
   factory->AddSpectator("nuE_gen := sqrt(W_neutrino_px_gen**2 + W_neutrino_py_gen**2 + W_neutrino_pz_gen**2)", "F");
   ...
   factory->AddSpectator("muE_gen := W_muon_e_gen", "F");
   factory->AddSpectator("muPx_gen := W_muon_px_gen", "F");
   factory->AddSpectator("muPy_gen := W_muon_py_gen", "F");
   factory->AddSpectator("muPz_gen := W_muon_pz_gen", "F");
   ...
   // factory->AddSpectator("jet1Pt := JetPFCor_Pt[0]", "F");
   // factory->AddSpectator("jet2Pt := JetPFCor_Pt[1]", "F");
   // factory->AddSpectator("jet1Eta := JetPFCor_Eta[0]", "F");
   // factory->AddSpectator("jet2Eta := JetPFCor_Eta[1]", "F");
   // factory->AddSpectator("jet1Phi := JetPFCor_Phi[0]", "F");
   // factory->AddSpectator("jet2Phi := JetPFCor_Phi[1]", "F");

   factory->AddSpectator("jet1E  := JetPFCor_E[0]", "F");
   factory->AddSpectator("jet1Px := JetPFCor_Px[0]", "F");
   factory->AddSpectator("jet1Py := JetPFCor_Py[0]", "F");
   factory->AddSpectator("jet1Pz := JetPFCor_Pz[0]", "F");
   factory->AddSpectator("jet2E  := JetPFCor_E[1]", "F");
   factory->AddSpectator("jet2Px := JetPFCor_Px[1]", "F");
   factory->AddSpectator("jet2Py := JetPFCor_Py[1]", "F");
   factory->AddSpectator("jet2Pz := JetPFCor_Pz[1]", "F");

   factory->AddSpectator("jet1E_gen  := JetGen_E[0]", "F");
   factory->AddSpectator("jet1Px_gen := JetGen_Px[0]", "F");
   factory->AddSpectator("jet1Py_gen := JetGen_Py[0]", "F");
   factory->AddSpectator("jet1Pz_gen := JetGen_Pz[0]", "F");
   factory->AddSpectator("jet2E_gen  := JetGen_E[1]", "F");
   factory->AddSpectator("jet2Px_gen := JetGen_Px[1]", "F");
   factory->AddSpectator("jet2Py_gen := JetGen_Py[1]", "F");
   factory->AddSpectator("jet2Pz_gen := JetGen_Pz[1]", "F");
   ...
   TString fname = "RD_mu_WW_CMSSW532.root";
   ...
   TCut mycut = "abs(W_mass_gen-80.4)< 10.";
  ...
  //                      "!H:!V:NTrees=100:PruneMethod=CostComplexity:PruneStrength=30" );

  factory->BookMethod( TMVA::Types::kBDT, "BDT", "!H:!V:NTrees=100:BoostType=AdaBoostR2");
